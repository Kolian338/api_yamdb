# Generated by Django 3.2 on 2023-12-15 07:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='titles_category', to='reviews.categories')),
        ...
        migrations.AddConstraint(
            model_name='reviews',
            constraint=models.UniqueConstraint(fields=('author', 'title'), name='repeated_review'),
        ),
    ]
